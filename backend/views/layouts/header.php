...
<body id="body">
  ...
  <section id="intro">
    ...
    <div class="intro-content">
      <h3 style="font-size: 60px ; color: #0c2e8a; margin-bottom: 30px; font-weight: 600">Registration of returnee travelling to Odisha</h3>
      <div>
        <a href="<?= Url::to(['site/form'])?>" class="btn-get-started scrollto">Registration Form</a>
        <a href="<?= Url::to(['site/track'])?>" class="btn-projects scrollto">Track Application</a>
      </div>
    </div>
