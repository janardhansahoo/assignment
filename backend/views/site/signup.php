        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="box wow fadeInLeft">
              ...
              <p class="description"><?= $form->field($model, 'password_hash')->label('Password')->passwordInput() ?></p>
              <p class="description"><?= $form->field($model, 'email')->textInput() ?></p>
              <p class="description"><?= $form->field($model, 'phone')->textInput() ?></p>
